	...
	return (
		<Section ref={ref} id='fixed-target' className='new-arrival'>
			...
			<Text data-scroll data-scroll-speed='-4'>
				There is new collection available for cool clothes in all sizes. This collection is a great way to find a new look
				for you. It offers a variety of cool apparel styles to fit your taste, while you can also find some cool clothes
